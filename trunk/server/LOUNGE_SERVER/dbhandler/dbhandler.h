...
#ifndef __lounge_dbhandler_h__
#define __lounge_dbhandler_h__
...
public:
	...
	bool dbConnect(const char*, const char*, const char*, const char*);
	bool dbInit(void);			// Initialize RDBMS Communications
	bool dbQuery(const char*);	// Execute Query to RDBMS System
